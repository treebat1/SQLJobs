--View Jobs Scheduled to run during certain time range in future.
--CJR:  3/13/2018:   This doesn't appear to work correctly.
...
--WHERE enabled = 1
--AND s.active_start_date <= '20131101'
--AND s.active_end_date >= '20131102'
--AND s.freq_type < 64
--AND s.freq_interval < 64

-----------------------------------------

--EXEC msdb.dbo.uspGetScheduleTimes '3/27/2018 14:00:00', '3/27/2018 17:00:00'
...
alter PROCEDURE dbo.uspGetScheduleTimes
(
       @startDate DATETIME,
       @endDate DATETIME
)
...
--WHERE js.jobName LIKE '%USER%FULL%'
